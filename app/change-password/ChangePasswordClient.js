...
export default function ChangePasswordClient() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-3 sm:p-4 font-sans">
            <div className="bg-white p-6 sm:p-8 rounded-2xl sm:rounded-2xl shadow-xl w-full max-w-md border-t-4 sm:border-t-8 border-purple-600">
                <h2 className="text-xl sm:text-2xl font-bold text-slate-800 mb-1 sm:mb-2 text-center">Установка пароля</h2>
                <p className="text-slate-500 mb-4 sm:mb-6 text-xs sm:text-sm text-center">
                ...
                <form onSubmit={handleChange} className="space-y-3 sm:space-y-4">
                    ...
                    <button
                        ...
                        className={`w-full py-2.5 sm:py-4 rounded-lg sm:rounded-xl font-bold text-white transition-all text-sm sm:text-base ${loading ? 'bg-purple-300' : 'bg-purple-600 hover:bg-purple-700'
                            }`}
                    >
